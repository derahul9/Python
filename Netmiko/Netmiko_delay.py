...
for device in (cisco, cisco1):
    ...
    output = net_connect.send_command("sh ip int br", delay_factor =2)
    print (output)

# You can also use the write and read channels if you wnat to see all the leading and trailing prompts
