#findall method returns all patterns that were matched and returns in form of a list
import re
...
# * means 0 or more number of times. + means 1 or more number of times
...
#sub method - This will replace a particular pattern with another value
