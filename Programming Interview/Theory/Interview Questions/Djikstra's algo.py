...
Brief algo is to initialize all the distance from source to infinity. Go over each node one by one and compute the smallest distance and keep on updating the dictionary values. Keep on
doing until you have the final value.
'''
class Node_Distance :
